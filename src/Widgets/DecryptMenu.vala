...
public class Installer.DecryptMenu: Gtk.Popover {
    ...
    private void create_decrypt_view (string device_path, DecryptFn decrypt) {
        ...
        var secondary_label = new Gtk.Label (_("Enter the partition's encryption password and set a name for the decrypted partition."));
        ...
        var pv_label = new Gtk.Label (_("Name:"));
